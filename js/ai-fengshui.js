...
(function (global) {
  ...
  function buildPrompt(ctx) {
    ...
    return `你是精通杨筠松（杨公）风水学的顾问，熟悉三合、二十四山、藏风聚气、室内形法与办公桌/床位布置。
请根据下列实测与课盘数据，用简洁中文给出可执行的室内布局建议（分条，勿恐吓，注明仅供文化参考）。
...
1. 地理气场与坐向总评（结合经纬度气候采光）
2. 办公桌：建议朝向哪一山/哪一方，人怎么坐，左右靠山与明堂
3. 床、沙发、灶/卫生间相对避忌（原则性）
4. 按二十四山指出 2～3 个宜加强摆放的方位及物件（绿植/灯/柜等）
5. 结合今日奇门生门/开门的「今日可微调」建议
字数控制在 800 字以内；专业词不要省略，但必须配白话。`;
  }
